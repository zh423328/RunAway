...
public class GameAttribute : MonoBehaviour {
	...
	public void Reset(){
        ...
        ControllerPlayer.instace.Reset();
        ControllerPlayer.instace.timeJump = 0;
        ControllerPlayer.instace.timeMagnet = 0;
        ControllerPlayer.instace.timeMultiply = 0;
        ControllerPlayer.instace.timeSprint = 0;
