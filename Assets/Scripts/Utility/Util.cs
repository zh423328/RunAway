    ...
    public class Util {
        ...
        public static string md5file(string file) 
        {
            try 
            {
                ...
                {
                    sb.Append(retVal[i].ToString("x2"));    //转换为16进制
                }
                return sb.ToString();
            } 
            catch (Exception ex)
        ...
        /// <summary>
        /// 应用程序内容路径
        /// 应用程序内容路径,可访问路径，可读 = Application.StreamingAssets
        /// </summary>
        ...
        public static AssetBundle LoadSceneAssetBundle(string url)
        {
            ResourceManager mgr = AppFacade.Instance.GetManager<ResourceManager>(ManagerName.Resource);
            if (mgr)
            {
                return mgr.LoadSceneAssetBundle(url);
            }
            else
                return null;
        }
        ...
        public static object[] CallMethod(string module, string func, params object[] args)
        {
            ...
            funcName = funcName.Replace("(Clone)", "");     //l拷贝对象
