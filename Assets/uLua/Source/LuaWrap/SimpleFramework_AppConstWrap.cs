...
public class SimpleFramework_AppConstWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("Retries", get_Retries, null),
			new LuaField("RetryInterval", get_RetryInterval, null),
	...
	{
		LuaScriptMgr.Push(L, SimpleFramework.AppConst.Retries);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_RetryInterval(IntPtr L)
	{
		LuaScriptMgr.Push(L, SimpleFramework.AppConst.RetryInterval);
		return 1;
	}
