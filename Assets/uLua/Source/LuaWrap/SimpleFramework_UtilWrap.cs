...
public class SimpleFramework_UtilWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("LoadSceneAssetBundle", LoadSceneAssetBundle),
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("LocalUrl", get_LocalUrl, null),
		};
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_LocalUrl(IntPtr L)
	{
		LuaScriptMgr.Push(L, SimpleFramework.Util.LocalUrl);
		return 1;
	}
	...
	static int LoadSceneAssetBundle(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		string arg0 = LuaScriptMgr.GetLuaString(L, 1);
		AssetBundle o = SimpleFramework.Util.LoadSceneAssetBundle(arg0);
		LuaScriptMgr.Push(L, o);
		return 1;
	}
